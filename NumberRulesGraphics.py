...
plt.plot(ruleswRLS1, rmsewRLS1, linewidth = 5, color = 'red', label = Serie)
plt.ylabel('RMSE')
plt.xlabel('Number of Rules')
plt.legend(loc='upper left')
plt.savefig(f'Graphics/RMSE_Rules_{Model}_{Serie}.eps', format='eps', dpi=1200)
plt.show()
...
plt.rc('font', size=30)
plt.rc('axes', titlesize=30)
plt.plot(ruleswRLS2, rmsewRLS2, linewidth = 5, color = 'red', label = Serie)
plt.ylabel('RMSE')
plt.xlabel('Number of Rules')
plt.legend(loc='upper left')
plt.savefig(f'Graphics/RMSE_Rules_{Model}_{Serie}.eps', format='eps', dpi=1200)
...
plt.rc('font', size=30)
plt.rc('axes', titlesize=30)
plt.plot(ruleswRLS3, rmsewRLS3, linewidth = 5, color = 'red', label = Serie)
plt.ylabel('RMSE')
plt.xlabel('Number of Rules')
plt.legend(loc='upper left')
plt.savefig(f'Graphics/RMSE_Rules_{Model}_{Serie}.eps', format='eps', dpi=1200)
...
plt.rc('font', size=30)
plt.rc('axes', titlesize=30)
plt.plot(ruleswRLS1, rmsewRLS1, linewidth = 5, label = 'S&P 500')
plt.plot(ruleswRLS2, rmsewRLS2, linewidth = 5, label = 'NASDAQ')
plt.plot(ruleswRLS3, rmsewRLS3, linewidth = 5, label = 'TAIEX')
plt.ylabel('RMSE')
plt.xlabel('Number of Rules')
plt.legend(loc='upper left')
plt.savefig('Graphics/RMSE_Rules_AllModels_NTSKwRLS.eps', format='eps', dpi=1200)
plt.show()